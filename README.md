...
### Color calibration
Turn all color vectors araound a chosen axis by a chosen angle. The axis and angle can be optionally determined by choosing an original color and a corresponding target color.
